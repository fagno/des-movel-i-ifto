...
image::savefiledb.gif[]

Após baixar os arquivos, abra o seu cliente SQLite, neste exemplo estou utilizando o DB Browser for SQLite, ferramenta que vocễ baixar através do link nas referências do material.
