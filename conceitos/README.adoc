...
image::est-proj-android-studio.png[] 
...
O modo debug é utilizado durante o desenvolvimento, e o aplicativo é assinado com o certificado digital de desenvolvimento, o qual é criado automaticamente pelo
Android Studio e fica na pasta ~/.android/debug.keystore.
